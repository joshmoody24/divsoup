defmodule Divsoup.Achievement.VoidElements.OpenMindedTest do
  use ExUnit.Case
  import Divsoup.AchievementTest.Helper

  alias Divsoup.Achievement.VoidElements.OpenMinded
  alias Divsoup.Util.Html

  test "earns achievement when all void elements omit trailing slash" do
    # Create an HTML document with various void elements, all without trailing slash
    void_elements = Html.void_elements()
    
    # Create tags without trailing slash
    ...
    assert_achievement_earned(OpenMinded, html)
  end

  test "doesn't earn achievement when some void elements have trailing slash" do
    html = """
    <html>
      <head>
    ...
    assert_achievement_not_earned(OpenMinded, html)
  end
